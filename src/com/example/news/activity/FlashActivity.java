...
public class FlashActivity extends Activity implements ResponseListener {
	...
	Handler handler = new Handler(){
	    ...
	    public void handleMessage(Message msg) {
			if (msg.what ==100) {
				((ListView) listView).setAdapter(new MainItemAdapter(FlashActivity.this, goodsInfo, options));
			}
	...
	public void onBackPressed() {
		DialogUtil.showExitDialog(FlashActivity.this);
	}
