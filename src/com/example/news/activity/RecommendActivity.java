...
public class RecommendActivity extends Activity implements ResponseListener {
	...
	Handler handler = new Handler(){
	    ...
	    public void handleMessage(Message msg) {
			if (msg.what ==100) {
				((ListView) listView).setAdapter(new MainItemAdapter(RecommendActivity.this, goodsInfo, options));
			}
	...
	Runnable runnable = new Runnable(){
	    @Override
	    public void run() {
	    	requestManager.getRecommendList();
	...
	public void onBackPressed() {
		DialogUtil.showExitDialog(RecommendActivity.this);
	}
